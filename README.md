...
![workflow](https://github.com/xyo-financial/sdk-rust/actions/workflows/makefile.yml/badge.svg)    ![workflow](https://github.com/xyo-financial/sdk-rust/actions/workflows/crates_xyo_http_publish.yml/badge.svg)    ![workflow](https://github.com/xyo-financial/sdk-rust/actions/workflows/crates_publish.yml/badge.svg)

<p align="center">
    <a href="https://xyo.financial" target="blank"><img alt="Rust Crab Mascot" width="50%" src="https://github.com/xyo-financial/sdk-rust/blob/main/docs/rust_mascot_sleek_neon.jpg?raw=true" /></a>
    <sup><br />Official Rust Mascot (Crab) for XYO.Financial Generated by Gemini AI and Imagined by Syniol Limited</sup>
</p>
